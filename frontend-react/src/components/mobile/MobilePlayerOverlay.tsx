...
const MobilePlayerOverlay: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full h-[100dvh] z-[1000] bg-neutral-900 flex flex-col p-6 animate-in slide-in-from-bottom duration-500 overflow-hidden">
      {/* Background Blur */}
      <div 
